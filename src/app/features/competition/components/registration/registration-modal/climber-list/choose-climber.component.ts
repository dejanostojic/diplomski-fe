...
@Component({
  selector: 'app-choose-climber',
  templateUrl: './choose-climber.component.html',
  styleUrls: ['./choose-climber.component.css']
})
export class ChooseClimberComponent implements OnInit, OnDestroy {
  climbers: Climber[];
  currentPage = 1;
  totalItems = 10;
  pageSize = 2;
  ...
  onClimberSelect(climber: Climber){
    this.selected = climber;
    // this.confirmFunction(climber);
    this.modal.close(climber);
  }
